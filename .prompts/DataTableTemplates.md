...
- Две ключевых сигнатуры - @field - значение поля текущего столбца текущего ряда, @row - объект всего текущего ряда таблицы. Таким образом, в компоненты передаются данные из объекта ряда.
